...
const HomepageSection = () => {
  return (
    <div className="mt-20 animate__animated animate__fadeInUp animate__delay-0.5s max-sm:w-11/12 max-sm:mx-auto flex flex-col items-center justify-center text-center ">
      <div className="py-10">
